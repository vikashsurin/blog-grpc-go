 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.blog.ListBlogRequestByUserId,
 *   !proto.blog.ListBlogResponseByUserId>}
 */
const methodDescriptor_BlogService_ListBlogByUserId = new grpc.web.MethodDescriptor(
  '/blog.BlogService/ListBlogByUserId',
  grpc.web.MethodType.SERVER_STREAMING,
  proto.blog.ListBlogRequestByUserId,
  proto.blog.ListBlogResponseByUserId,
  /**
   * @param {!proto.blog.ListBlogRequestByUserId} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.blog.ListBlogResponseByUserId.deserializeBinary
);
 ...
 *   !proto.blog.ListBlogResponseByUserId>}
 */
const methodInfo_BlogService_ListBlogByUserId = new grpc.web.AbstractClientBase.MethodInfo(
  proto.blog.ListBlogResponseByUserId,
  /**
   * @param {!proto.blog.ListBlogRequestByUserId} request
   * @return {!Uint8Array}
...
/**
 * @param {!proto.blog.ListBlogRequestByUserId} request The request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!grpc.web.ClientReadableStream<!proto.blog.ListBlogResponseByUserId>}
 *     The XHR Node Readable Stream
 */
proto.blog.BlogServiceClient.prototype.listBlogByUserId =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/blog.BlogService/ListBlogByUserId',
      request,
      metadata || {},
      methodDescriptor_BlogService_ListBlogByUserId);
};
 ...
 *     The XHR Node Readable Stream
 */
proto.blog.BlogServicePromiseClient.prototype.listBlogByUserId =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/blog.BlogService/ListBlogByUserId',
      request,
